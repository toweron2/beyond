...
func (c *likeClient) Thumbup(ctx context.Context, in *ThumbupReq, opts ...grpc.CallOption) (*ThumbupResp, error) {
	out := new(ThumbupResp)
...
func (c *likeClient) IsThumbup(ctx context.Context, in *IsThumbupReq, opts ...grpc.CallOption) (*IsThumbupResp, error) {
	out := new(IsThumbupResp)
...
type LikeServer interface {
	...
	IsThumbup(context.Context, *IsThumbupReq) (*IsThumbupResp, error)
...
func (UnimplementedLikeServer) Thumbup(context.Context, *ThumbupReq) (*ThumbupResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Thumbup not implemented")
}
func (UnimplementedLikeServer) IsThumbup(context.Context, *IsThumbupReq) (*IsThumbupResp, error) {
...
func _Like_Thumbup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LikeServer).Thumbup(ctx, req.(*ThumbupReq))
	}
...
func _Like_IsThumbup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LikeServer).IsThumbup(ctx, req.(*IsThumbupReq))
	}
	return interceptor(ctx, in, info, handler)
}
