...
type ArticleClient interface {
	...
	ArticleDelete(ctx context.Context, in *ArticleDeleteReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *articleClient) ArticleDelete(ctx context.Context, in *ArticleDeleteReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type ArticleServer interface {
	...
	ArticleDelete(context.Context, *ArticleDeleteReq) (*emptypb.Empty, error)
...
func (UnimplementedArticleServer) ArticleDelete(context.Context, *ArticleDeleteReq) (*emptypb.Empty, error) {
