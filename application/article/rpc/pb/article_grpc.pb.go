...
type ArticleClient interface {
	...
	ArticleDelete(ctx context.Context, in *ArticleDeleteReq, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *articleClient) Articles(ctx context.Context, in *ArticlesReq, opts ...grpc.CallOption) (*ArticlesResp, error) {
...
func (c *articleClient) ArticleDelete(ctx context.Context, in *ArticleDeleteReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *articleClient) ArticleDetail(ctx context.Context, in *ArticleDetailReq, opts ...grpc.CallOption) (*ArticleDetailResp, error) {
...
type ArticleServer interface {
	...
	Articles(context.Context, *ArticlesReq) (*ArticlesResp, error)
	ArticleDelete(context.Context, *ArticleDeleteReq) (*empty.Empty, error)
...
func (UnimplementedArticleServer) Articles(context.Context, *ArticlesReq) (*ArticlesResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Articles not implemented")
}
func (UnimplementedArticleServer) ArticleDelete(context.Context, *ArticleDeleteReq) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ArticleDelete not implemented")
}
func (UnimplementedArticleServer) ArticleDetail(context.Context, *ArticleDetailReq) (*ArticleDetailResp, error) {
...
func _Article_Articles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArticleServer).Articles(ctx, req.(*ArticlesReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Article_ArticleDelete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArticleServer).ArticleDelete(ctx, req.(*ArticleDeleteReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Article_ArticleDetail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArticleServer).ArticleDetail(ctx, req.(*ArticleDetailReq))
	}
	return interceptor(ctx, in, info, handler)
}
